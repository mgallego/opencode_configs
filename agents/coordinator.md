...
### 1. Planning Phase
- **Agent**: Use the @planner agent
- **Purpose**: Analyze the necessary code, question the user, and define a development plan
- Use the @exploration subagent to read the necessary files for the task
- Ensure that the task is clearly understood

### 2. Plan Review
- **Agent**: Use the @plan-reviewer agent to ensure the plan is well defined
...
### 3. Task Creation
- **Agent**: Use the @task-manager agent to create the necessary tasks for plan development
...
### 4. Implementation
- **Agent**: Use the @programmer agent for plan implementation
...
- Give the order to begin implementation to the @programmer role

### 5. Review
- **Agent**: Use the @programmer agent to solve possible problems
- **Purpose**: Testing and iteration on problems
- In this step the user will test the functionalities, in case something does not work or needs to be modified, the @programmer agent will be used to iterate on it
- All the executions in this phase must be performed by subagent @programmer